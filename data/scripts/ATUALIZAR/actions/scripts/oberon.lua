...
local config = {
	...
	timeStorage = 33000, -- storage que bloquea la palanca ----- para otra quest
...
local player_positions = {
    [1] = {fromPos = Position(33369, 31334, 9), toPos = Position(33376, 31316, 9)},
	[2] = {fromPos = Position(33370, 31334, 9), toPos = Position(33376, 31316, 9)},
	[3] = {fromPos = Position(33371, 31334, 9), toPos = Position(33376, 31316, 9)},
	[4] = {fromPos = Position(33372, 31334, 9), toPos = Position(33376, 31316, 9)},
	[5] = {fromPos = Position(33373, 31334, 9), toPos = Position(33376, 31316, 9)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33370, 31305, 9), toPos = Position(33385, 31318, 9)},
    
}

function bossArea()
   Game.createMonster("Grand Master Oberon1", Position(33376, 31312, 9))
    return 
end
...
addEvent(bossArea, 500)
cleanZone(Position(33370, 31305, 9), Position(33385, 31318, 9), true)
    return true
end
