...
local config = {
	...
	[32491]	=	{NAME = 'Flying Book', 				ID = 126,	TYPE = TYPE_MONSTER,	CHANCE = 30,	FAIL_MSG = { {2, 'The Flying Book got scared and ran away.'}, {4, 'The Flying Book is trying to nibble.'} }, SUCCESS_MSG = 'You tamed the Flying Book.'}
}
