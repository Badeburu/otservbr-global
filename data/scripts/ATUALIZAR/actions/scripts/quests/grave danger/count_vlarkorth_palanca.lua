...
local config = {
	...
	timeStorage = 26001, -- storage que bloquea la palanca ----- para otra quest
...
local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33447, 31447, 13), toPos = Position(33465, 31428, 13)},
    
}

function bosssi1Area()
   Game.createMonster("Count Vlarkorth", Position(33456, 31428, 13))  
    return 
end
...
addEvent(bosssi1Area, 500)
cleanZone(Position(33447, 31447, 13), Position(33465, 31428, 13), true) 
    return true
end
