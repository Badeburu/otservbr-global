...
local config = {
	...
	timeStorage = 26005, -- storage que bloquea la palanca ----- para otra quest
...
local player_positions = {
    [1] = {fromPos = Position(33424, 31413, 13), toPos = Position(33424, 31431, 13)},
	[2] = {fromPos = Position(33425, 31413, 13), toPos = Position(33424, 31431, 13)},
	[3] = {fromPos = Position(33426, 31413, 13), toPos = Position(33424, 31431, 13)},
	[4] = {fromPos = Position(33427, 31413, 13), toPos = Position(33424, 31431, 13)},
	[5] = {fromPos = Position(33428, 31413, 13), toPos = Position(33424, 31431, 13)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33414, 31451, 13), toPos = Position(33435, 31426, 13)},
    
}

function bosssi5Area()
   Game.createMonster("Sir Baeloc", Position(33422, 31441, 13))  
    return 
end
function bosssi6Area()
   Game.createMonster("Sir Nictros", Position(33426, 31441, 13))  
    return 
end
...
addEvent(bosssi5Area, 500)
addEvent(bosssi6Area, 500)
cleanZone(Position(33414, 31451, 13), Position(33435, 31426, 13), true) 
    return true
end
