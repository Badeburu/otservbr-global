...
local config = {
	...
	timeStorage = 26004, -- storage que bloquea la palanca ----- para otra quest
...
local player_positions = {
    [1] = {fromPos = Position(33422, 31493, 13), toPos = Position(33424, 31479, 13)},
	[2] = {fromPos = Position(33423, 31493, 13), toPos = Position(33424, 31479, 13)},
	[3] = {fromPos = Position(33424, 31493, 13), toPos = Position(33424, 31479, 13)},
	[4] = {fromPos = Position(33425, 31493, 13), toPos = Position(33424, 31479, 13)},
	[5] = {fromPos = Position(33426, 31493, 13), toPos = Position(33424, 31479, 13)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33414, 31484, 13), toPos = Position(33434, 31463, 13)},
    
}

function bosssi4Area()
   Game.createMonster("Lord Azaram", Position(33424, 31471, 13))  
    return 
end
...
addEvent(bosssi4Area, 500)
cleanZone(Position(33414, 31484, 13), Position(33434, 31463, 13), true) 
    return true
end
