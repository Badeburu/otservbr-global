...
local config = {
	...
	timeStorage = 26002, -- storage que bloquea la palanca ----- para otra quest
...
local player_positions = {
    [1] = {fromPos = Position(33455, 31493, 13), toPos = Position(33456, 31480, 13)},
	[2] = {fromPos = Position(33456, 31493, 13), toPos = Position(33456, 31480, 13)},
	[3] = {fromPos = Position(33457, 31493, 13), toPos = Position(33456, 31480, 13)},
	[4] = {fromPos = Position(33458, 31493, 13), toPos = Position(33456, 31480, 13)},
	[5] = {fromPos = Position(33459, 31493, 13), toPos = Position(33456, 31480, 13)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33447, 31482, 13), toPos = Position(33465, 31462, 13)},
    
}

function bosssi2Area()
   Game.createMonster("Duke Krule", Position(33456, 31472, 13))  
    return 
end
...
addEvent(bosssi2Area, 500)
cleanZone(Position(33447, 31482, 13), Position(33465, 31462, 13), true) 
    return true
end
