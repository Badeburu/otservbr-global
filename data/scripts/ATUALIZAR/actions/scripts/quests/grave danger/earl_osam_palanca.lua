...
local config = {
	...
	timeStorage = 26003, -- storage que bloquea la palanca ----- para otra quest
...
local player_positions = {
    [1] = {fromPos = Position(33516, 31444, 13), toPos = Position(33495, 31438, 13)},
	[2] = {fromPos = Position(33517, 31444, 13), toPos = Position(33495, 31438, 13)},
	[3] = {fromPos = Position(33518, 31444, 13), toPos = Position(33495, 31438, 13)},
	[4] = {fromPos = Position(33519, 31444, 13), toPos = Position(33495, 31438, 13)},
	[5] = {fromPos = Position(33520, 31444, 13), toPos = Position(33495, 31438, 13)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33479, 31448, 13), toPos = Position(33498, 31429, 13)},
    
}

function bosssi3Area()
...
addEvent(bosssi3Area, 500)
cleanZone(Position(33479, 31448, 13), Position(33498, 31429, 13), true) 
    return true
end
