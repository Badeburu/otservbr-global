...
local config = {
	first = {
	[1] = {fromPosition = Position(33882, 32063, 14), toPosition = Position(33888, 32068, 14), stgRoom = Storage.DangerousDepths.Scouts.firstBarrel},
	},
	second = {
	[1] = {fromPosition = Position(33913, 32033, 14), toPosition = Position(33916, 32037, 14), stgRoom = Storage.DangerousDepths.Scouts.secondBarrel},
	},
	third = {
	[1] = {fromPosition = Position(33870, 32015, 14), toPosition = Position(33874, 32020, 14), stgRoom = Storage.DangerousDepths.Scouts.thirdBarrel},
	},
	fourth = {
	[1] = {fromPosition = Position(33847, 31987, 14), toPosition = Position(33852, 31991, 14), stgRoom = Storage.DangerousDepths.Scouts.fourthBarrel}, 
	},
	fifth = {
	[1] = {fromPosition = Position(33934, 31991, 14), toPosition = Position(33942, 31998, 14), stgRoom = Storage.DangerousDepths.Scouts.fifthBarrel},
	},
}
...
function onUse(player, item)
	...
	local posBarril = Position(33838, 32079, 14)
	...
	if item:getId() == 1945 then
		if player:getStorageValue(Storage.DangerousDepths.Scouts.Growth) == 1 and stgCount < 5 and barrelTimer <= 0 then		
			local Barril = Game.createItem(26141, 1, posBarril)
			...
			player:setStorageValue(Storage.DangerousDepths.Scouts.barrelTimer, os.time() + 3*60) -- Só para barrar.
