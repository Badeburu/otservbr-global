local flowerPositions = {
	[1] = {itemid = 2762, position = Position(33459, 32707, 14)},
	[2] = {itemid = 2762, position = Position(33455, 32708, 14)},
	[3] = {itemid = 2764, position = Position(33456, 32708, 14)},
	[4] = {itemid = 2763, position = Position(33457, 32708, 14)},
	[5] = {itemid = 2764, position = Position(33458, 32708, 14)},
	[6] = {itemid = 2763, position = Position(33459, 32708, 14)},
	[7] = {itemid = 2762, position = Position(33460, 32708, 14)},
	[8] = {itemid = 2763, position = Position(33456, 32709, 14)},
