...
local config = {
	...
	timeStorage = 31000, -- storage que bloquea la palanca ----- para otra quest
...
local player_positions = {
    [1] = {fromPos = Position(32302, 31088, 14), toPos = Position(32271, 31099, 14)},
	[2] = {fromPos = Position(32302, 31089, 14), toPos = Position(32271, 31099, 14)},
	[3] = {fromPos = Position(32302, 31090, 14), toPos = Position(32271, 31099, 14)},
	[4] = {fromPos = Position(32302, 31091, 14), toPos = Position(32271, 31099, 14)},
	[5] = {fromPos = Position(32302, 31092, 14), toPos = Position(32271, 31099, 14)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(32258, 31080, 14), toPos = Position(32279, 31101, 14)},
    
}

function boss5Area()
   Game.createMonster("melting frozen horror", Position(32269, 31092, 14))
...
addEvent(boss5Area, 500)
cleanZone(Position(32258, 31080, 14), Position(32279, 31101, 14), true)
    return true
end
