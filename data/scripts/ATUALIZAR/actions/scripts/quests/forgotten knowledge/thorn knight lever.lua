...
local config = {
	...
	timeStorage = 29000, -- storage que bloquea la palanca ----- para otra quest
...
local player_positions = {
    [1] = {fromPos = Position(32657, 32877, 14), toPos = Position(32626, 32887, 14)},
	[2] = {fromPos = Position(32657, 32878, 14), toPos = Position(32626, 32887, 14)},
	[3] = {fromPos = Position(32657, 32879, 14), toPos = Position(32626, 32887, 14)},
	[4] = {fromPos = Position(32657, 32880, 14), toPos = Position(32626, 32887, 14)},
	[5] = {fromPos = Position(32657, 32881, 14), toPos = Position(32626, 32887, 14)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(32613, 32869, 14), toPos = Position(32635, 32890, 14)},
    
}

function boss3Area()
   Game.createMonster("mounted thorn knight", Position(32624, 32881, 14))
...
addEvent(boss3Area, 500)
cleanZone(Position(32613, 32869, 14), Position(32635, 32890, 14), true)
    return true
end
