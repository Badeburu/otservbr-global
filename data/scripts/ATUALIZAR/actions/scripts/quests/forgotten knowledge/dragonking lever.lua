...
local config = {
	...
	timeStorage = 30000, -- storage que bloquea la palanca ----- para otra quest
...
local player_positions = {
    [1] = {fromPos = Position(33391, 31178, 10), toPos = Position(33360, 31190, 10)},
	[2] = {fromPos = Position(33391, 31179, 10), toPos = Position(33360, 31190, 10)},
	[3] = {fromPos = Position(33391, 31180, 10), toPos = Position(33360, 31190, 10)},
	[4] = {fromPos = Position(33391, 31181, 10), toPos = Position(33360, 31190, 10)},
	[5] = {fromPos = Position(33391, 31182, 10), toPos = Position(33360, 31190, 10)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33348, 31171, 10), toPos = Position(33369, 31192, 10)},
    
}

function boss4Area()
   Game.createMonster("dragonking zyrtarch", Position(33358, 31183, 10))
...
addEvent(boss4Area, 500)
cleanZone(Position(33348, 31171, 10), Position(33369, 31192, 10), true)
    return true
end
