...
local config = {
	...
	timeStorage = 27000, -- storage que bloquea la palanca ----- para otra quest
...
local player_positions = {
    [1] = {fromPos = Position(32902, 31623, 14), toPos = Position(32914, 31607, 14)},
	[2] = {fromPos = Position(32902, 31624, 14), toPos = Position(32914, 31607, 14)},
	[3] = {fromPos = Position(32902, 31625, 14), toPos = Position(32914, 31607, 14)},
	[4] = {fromPos = Position(32902, 31626, 14), toPos = Position(32914, 31607, 14)},
	[5] = {fromPos = Position(32902, 31627, 14), toPos = Position(32914, 31607, 14)}
}


local configg = {
    maxPlayers = 0,
     room = {fromPos = Position(32901, 31588, 14), toPos = Position(32922, 31609, 14)},
    
}

function boss1Area()
   Game.createMonster("lady tenebris", Position(32912, 31599, 14))
...
addEvent(boss1Area, 500)
cleanZone(Position(32901, 31588, 14), Position(32922, 31609, 14), true)
    return true
end
