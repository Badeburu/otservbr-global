...
local config = {
    ...
    timeStorage = 35000, -- id of lever before pulled
    pulled_id = 1946 -- id of lever after pulled
}

local player_positions = {
    [1] = {fromPos = Position(33395, 32661, 6), toPos = Position(33395, 32658, 6)},
	[2] = {fromPos = Position(33395, 32662, 6), toPos = Position(33395, 32658, 6)},
	[3] = {fromPos = Position(33394, 32662, 6), toPos = Position(33395, 32658, 6)},
	[4] = {fromPos = Position(33396, 32662, 6), toPos = Position(33395, 32658, 6)},
	[5] = {fromPos = Position(33395, 32663, 6), toPos = Position(33395, 32658, 6)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33386, 32639, 6), toPos = Position(33405, 32659, 6)},
    
}

function boss200Area()
   Game.createMonster("Scarlett Etzel", Position(33396, 32642, 6))
...
if #getPlayersInArea(configg.room.fromPos, configg.room.toPos) > configg.maxPlayers then
  ...
  addEvent(boss200Area, 500)
    cleanZone(Position(33386, 32639, 6), Position(33405, 32659, 6), true)
    return true
end
