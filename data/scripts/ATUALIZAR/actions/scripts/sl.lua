...
local config = {
	...
	timeStorage = 25000, -- storage que bloquea la palanca ----- para otra quest
...
local player_positions = {
    [1] = {fromPos = Position(32751, 32747, 10), toPos = Position(32759, 32726, 10)},
	[2] = {fromPos = Position(32752, 32747, 10), toPos = Position(32759, 32726, 10)},
	[3] = {fromPos = Position(32753, 32747, 10), toPos = Position(32759, 32726, 10)},
	[4] = {fromPos = Position(32754, 32747, 10), toPos = Position(32759, 32726, 10)},
	[5] = {fromPos = Position(32755, 32747, 10), toPos = Position(32759, 32726, 10)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(32748, 32709, 10), toPos = Position(32770, 32728, 10)},
    
}

function bosssaArea()
   Game.createMonster("Ghulosh", Position(32760, 32719, 10))
...
if #getPlayersInArea(configg.room.fromPos, configg.room.toPos) > configg.maxPlayers then
  ...
  addEvent(bosssaArea, 500)
    cleanZone(Position(32748, 32709, 10), Position(32770, 32728, 10), true)
