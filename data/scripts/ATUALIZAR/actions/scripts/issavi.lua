...
local config = {
	...
	timeStorage = 26000, -- storage que bloquea la palanca ----- para otra quest
...
local player_positions = {
    [1] = {fromPos = Position(33918, 31626, 8), toPos = Position(33919, 31646, 8)},
	[2] = {fromPos = Position(33919, 31626, 8), toPos = Position(33919, 31646, 8)},
	[3] = {fromPos = Position(33920, 31626, 8), toPos = Position(33919, 31646, 8)},
	[4] = {fromPos = Position(33921, 31626, 8), toPos = Position(33919, 31646, 8)},
	[5] = {fromPos = Position(33922, 31626, 8), toPos = Position(33919, 31646, 8)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33908, 31636, 8), toPos = Position(33931, 31662, 8)},
    
}

function bosssArea()
   Game.createMonster("Urmahlullu the Immaculate", Position(33919, 31648, 8))  
    return 
end
...
addEvent(bosssArea, 500)
cleanZone(Position(33908, 31636, 8), Position(33931, 31662, 8), true) 
    return true
end
